...
interface, at 30 bytes instead of 31 kB. Re-polling is the commonest thing an
...
every widget including those scrolled out of view: at 1000 rows that is 311 kB
against 9.0 kB clipped, and against 16.7 kB for a screenshot of the same
window.
